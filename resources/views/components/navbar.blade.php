<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 relative">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button id="navbar-toggler" data-collapse-toggle="navbar-dropdown" type="button"
        ...
        <div class="hidden absolute top-full left-0 w-full md:static md:block md:w-auto" id="navbar-dropdown">
            <ul
...
<script>
    ...
    navbarToggler.addEventListener('click', function () {
        const expanded = navbarDropdown.classList.toggle('hidden');
        if (!expanded) {
    ...
    function closeNavbarOnOutsideClick(event) {
        if (!navbarDropdown.contains(event.target) && !navbarToggler.contains(event.target)) {
